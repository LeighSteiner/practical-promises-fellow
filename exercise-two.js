...
function problemC () {
  ...
  Promise.each(filenames, (fileName) => promisifiedReadFile(fileName).then(blue))
  .then( () => {console.log('done')})
}
...
function problemE () {
  ...
  function promisifiedWriteFile (filename, str) {
    // your code here
    //see https://github.com/FullstackAcademy/1706-GH-NY-Library/blob/master/junior-phase/10-practical-promises/solution/exercise-two.js
    //for solution
  }
}
